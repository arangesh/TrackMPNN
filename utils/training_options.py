...
parser.add_argument('--greedy', action='store_true', default=False, help='decode tracks in a greedy manner (if not activated, use Hungarian)')
...
args.hungarian = not args.greedy
